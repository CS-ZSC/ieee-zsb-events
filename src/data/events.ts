...
export const eventsData: Event[] = [
  {
    ...
    competitionsDescription:
      "Mutex 2025 hosts a diverse set of competitions covering software development, cybersecurity, robotics, and green tech, with rewards that recognize innovation and excellence.",
    competitions: [
      {
        id: mutualId++,
        name: "Semaphore",
        shortName: "semaphore",
        image: "/events/mutex/competitions/semaphore.webp",
        description:
      ...
      },
      {
        ...
        name: "Deadlock CTF",
        shortName: "deadlock",
        image: "/events/mutex/competitions/deadlock.webp",
        description:
      ...
      },
      {
        ...
        image: "/events/mutex/competitions/ffc.webp",
        description:
        ...
        trophies: [
          ...
          { id: mutualId++, place: "3rd", amount: "5,000 LE" },
          { id: mutualId++, place: "Best Design", amount: "2,500 LE" },
          { id: mutualId++, place: "Best Business", amount: "2,500 LE" },
        ],
        rulesDescription:
          "All participants must follow the official guidelines detailed in the competition rulebook. Review the full rules via the provided link before competing.",
      },
      {
        ...
        name: "Enrginity",
        shortName: "eco-e",
        image: "/events/mutex/competitions/enrginity.webp",
        description:
        ...
        certificates: [
          {
            id: mutualId++,
            title: "Best Ideation Award",
          },
          {
            id: mutualId++,
            title: "Best BMC Award",
          },
        ],
        rulesDescription:
          "All participants must follow the official guidelines detailed in the competition rulebook. Review the full rules via the provided link before competing.",
